...
import static jsynctech.com.app_demo.DEMO1.Main.ItemConverter.createNextModel;
import static jsynctech.com.app_demo.DEMO1.Main.ItemConverter.createTitleModel;
...
public class MainDemo1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            item.setNextTitle("BottomAppBar");
            ...
            item.setActivity((Class<? extends AppCompatActivity>) Class.forName("jsynctech.com.app_demo.DEMO1.Setting.SettingActivity"));
            viewDetailModelList.add(item);
            item = new ViewDetailModel();
            item.setNextTitle("FoodsOrder");
            item.setIcons(getResources().getDrawable(R.drawable.ic_local_cafe_black_24dp));
            item.setActivity((Class<? extends AppCompatActivity>) Class.forName("jsynctech.com.app_demo.DEMO1.FoodOrder.StoreDetailActivity"));
            viewDetailModelList.add(item);
        ...
        MainAdapter demo1Adapter = new MainAdapter();
        ...
        demo1Adapter.setOnItemClickListenerNextActivity(new InterfaceNext() {
            ...
            public void setOnClickListener(int position) {
                ...
                MainDemo1Activity.this.startActivity(new Intent(getApplicationContext(), item.getActivity()));
            }
        });
    }
